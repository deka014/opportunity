...
app.get('/webhook/', function (req, res) {
    if (req.query['hub.verify_token'] === '<revoked>') {
...
//     response = {
//       "text": `Hey Deepjyoti Deka , You sent me : "${received_message.text}". But i have a boyfriend ..next try! !`
//     }
